...
public class BinanceApiAsyncRestClientImpl implements BinanceApiAsyncRestClient {
	...
	public BinanceApiAsyncRestClientImpl(String apiKey, String secret, DomainType type) {
		binanceApiService = createService(BinanceApiService.class, apiKey, secret, type);
	}
