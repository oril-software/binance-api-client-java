...
public class BinanceApiWebSocketClientImpl implements BinanceApiWebSocketClient, Closeable {
	...
	public BinanceApiWebSocketClientImpl(OkHttpClient client, DomainType type) {
		this.client = client;
		this.type = type;
	}
	...
	private Closeable createNewWebSocket(String channel, BinanceApiWebSocketListener<?> listener) {
		String url = type == DomainType.Us ? BinanceApiConstants.WS_API_BASE_US_URL : BinanceApiConstants.WS_API_BASE_URL;
