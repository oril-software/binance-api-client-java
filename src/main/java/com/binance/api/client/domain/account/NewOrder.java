...
public class NewOrder {
	...
	public static NewOrder stopLimitSell(String symbol, String quantity, String price, String stopPrice) {
		return new NewOrder(symbol, OrderSide.SELL, OrderType.STOP_LOSS_LIMIT, TimeInForce.GTC, quantity, price, stopPrice);
	}
